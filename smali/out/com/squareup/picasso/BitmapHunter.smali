...
.method static applyCustomTransformations(Ljava/util/List;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    :try_end_12
    .catch Ljava/lang/RuntimeException; {:try_start_e .. :try_end_12} :catch_87
...
.method static transformResult(Lcom/squareup/picasso/Request;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    :cond_2b6
    :goto_2b6
    if-ne v9, v2, :cond_2ba

    if-eq v10, v3, :cond_2b5
...
.method hunt()Landroid/graphics/Bitmap;
    ...
    move-result-object v3
    :try_end_65
    .catchall {:try_start_5f .. :try_end_65} :catchall_6c
    ...
    monitor-exit v2
    :try_end_eb
    .catchall {:try_start_9c .. :try_end_eb} :catchall_f3
