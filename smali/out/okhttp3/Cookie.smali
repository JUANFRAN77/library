...
.method static parse(JLokhttp3/HttpUrl;Ljava/lang/String;)Lokhttp3/Cookie;
    ...
    :try_end_7e
    .catch Ljava/lang/IllegalArgumentException; {:try_start_76 .. :try_end_7e} :catch_84
    ...
    move-result-wide v27
    :try_end_92
    .catch Ljava/lang/NumberFormatException; {:try_start_8e .. :try_end_92} :catch_98
    ...
    move-result-object v0
    :try_end_a6
    .catch Ljava/lang/IllegalArgumentException; {:try_start_a2 .. :try_end_a6} :catch_ab
...
.method private static parseExpires(Ljava/lang/String;II)J
    ...
    if-lt v6, v11, :cond_aa

    const/16 v11, 0x63

    if-gt v6, v11, :cond_aa
    ...
    if-lt v6, v11, :cond_11b

    .line 366
    if-eq v5, v9, :cond_115

    .line 367
    if-lt v4, v10, :cond_10f
